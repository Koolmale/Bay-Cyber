...
export const Tutoriallist = () => (
    ...
    <div class="list-group">
        ...
        <a href="/Tutorial" class="list-group-item list-group-item-action active">
            <i class="fa fa-camera"></i> Home <span class="badge badge-pill badge-primary pull-right"></span>
        </a>
        ...
        <a href="#" class="list-group-item list-group-item-action">
            <i class="fa fa-music"></i> Cryptography<span class="badge badge-pill badge-primary pull-right"></span>
        </a>
        <a href="#" class="list-group-item list-group-item-action">
